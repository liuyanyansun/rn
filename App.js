						...
						<Scene key="root">
							...
							>
								...
								<Scene 
									...
									title="个人中心"
								>
									<Scene key="geren" component={Userinfor} hideNavBar/>
									<Scene key="fabu" component={Fabu} renderTitle="我的发布" navigationBarStyle={{backgroundColor:'red'}} titleStyle={{flex:1,textAlign:'center',color:'white'}} renderRightButton={<Image source={require('./assets/bu.png')}/>} />
								</Scene>
